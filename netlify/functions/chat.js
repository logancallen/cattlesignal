...
- 1. Reads COT data from data/cot-latest.json (refreshed weekly by GitHub Action)
- 1. Injects both into system prompt dynamically
- 1. CORS set to ‘*’ to fix external user access
   */
...
1. POSITIONING (see COT data above for current numbers)
